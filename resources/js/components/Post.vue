    ...
    <div class="bg-white rounded shadow w-2/3 mt-6 overflow-hidden">
        <div class="flex flex-col p-4">
            <div class="flex items-center">
                <div class="w-8">
                    <img src="https://pbs.twimg.com/profile_images/966027138225922048/z7AXDFbc_400x400.jpg"
        ...
        <div class="flex justify-between px-4 pt-2 text-gray-700 text-sm">
            <div class="flex">
                ...
                <p>Cristian Torres and 137 others</p>
            </div>
